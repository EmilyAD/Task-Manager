        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
          <div className="text-center">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-gray-900 dark:text-white mb-6">
              Welcome to{" "}
              <span className="text-green-600">Bloomly</span>
            </h1>
          ...
          {/* Decorative Plants */}
          <div className="absolute top-10 left-10 text-6xl animate-bounce opacity-30" style={{ animationDelay: "0.2s" }}>🌸</div>
          <div className="absolute top-20 right-20 text-6xl animate-bounce opacity-30" style={{ animationDelay: "0.4s" }}>🌻</div>
          <div className="absolute bottom-20 left-1/4 text-6xl animate-bounce opacity-30" style={{ animationDelay: "0.6s" }}>🌺</div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Visual Progress</h3>
            <p className="text-gray-600 dark:text-gray-400">Watch your tasks grow from seeds to plants as you complete them.</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl">
            ...
            <p className="text-gray-600 dark:text-gray-400">Organize and track tasks with categories and simple controls.</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Track Growth</h3>
            <p className="text-gray-600 dark:text-gray-400">Monitor your productivity and see how much you accomplish.</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl">
            ...
            <p className="text-gray-600 dark:text-gray-400">Unlock achievements and maintain productivity streaks.</p>
          </div>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 p-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-100 rounded-full mb-6">
                <span className="text-sm font-semibold text-emerald-700">Beautiful Gardens</span>
              </div>
              <h2 className="text-4xl font-bold text-gray-900 mb-6">Your Personal Productivity Garden</h2>
            ...
            <div className="bg-gradient-to-b from-sky-100 to-emerald-100 rounded-2xl p-8 min-h-[300px] relative overflow-hidden">
              <div className="text-right mb-4 text-5xl">☀️</div>
      ...
      <footer className="border-t border-gray-200 dark:border-gray-800 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl text-gray-900 dark:text-white">Bloomly</span>
          </div>
          <p className="text-gray-600 dark:text-gray-400">© 2026 Bloomly. All rights reserved.</p>
        </div>
      </footer>
