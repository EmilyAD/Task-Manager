    ...
    <section className="min-h-screen bg-[#f4f4f1] dark:bg-[#010513] flex items-center justify-center px-4 py-8 transition-colors duration-300">
      <div className="w-full max-w-[760px] bg-white dark:bg-[#10151C] rounded-[20px] shadow-[0_12px_40px_rgba(0,0,0,0.08)] px-6 py-10 md:px-12 md:py-12 flex flex-col items-center transition-colors duration-300">
        ...
        <form className="w-full max-w-[580px] flex flex-col" onSubmit={handleSubmit} noValidate>
          ...
          <label className="text-sm font-bold text-[#23311f] dark:text-white mt-2">Email</label>
          <input
            name="email"
            type="email"
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-10 bg-[#43A047] text-white py-4 rounded-xl font-bold hover:opacity-90 transition disabled:opacity-60"
          >
        ...
        <p className="mt-10 text-gray-500 text-center">
          ...
          <Link to="/register" className="text-[#43A047] font-bold">Sign up</Link>
        </p>
